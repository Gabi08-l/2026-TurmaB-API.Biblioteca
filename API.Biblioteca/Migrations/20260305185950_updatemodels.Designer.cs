...
namespace API.Biblioteca.Migrations
{
    ...
    [Migration("20260305185950_updatemodels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Biblioteca.Models.LivroGenero", b =>
                {
            ...
            modelBuilder.Entity("GeneroLivro", b =>
                {
                    b.Property<Guid>("GenerosGeneroId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("LivrosLivroId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("GenerosGeneroId", "LivrosLivroId");
            ...
            modelBuilder.Entity("API.Biblioteca.Models.LivroGenero", b =>
                {
                    b.HasOne("API.Biblioteca.Models.Genero", "Genero")
                        .WithMany()
            ...
            modelBuilder.Entity("GeneroLivro", b =>
                {
                    b.HasOne("API.Biblioteca.Models.Genero", null)
                        .WithMany()
