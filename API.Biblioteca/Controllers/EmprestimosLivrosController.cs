...
namespace API.Biblioteca.Controllers
{
    ...
    public class EmprestimosLivrosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<EmprestimoLivro>>> GetEmprestimosLivros()
        {
            return await _context.EmprestimosLivros.ToListAsync();
        }
        ...
        {
            var emprestimoLivro = await _context.EmprestimosLivros.FindAsync(id);
        ...
        {
            _context.EmprestimosLivros.Add(emprestimoLivro);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteEmprestimoLivro(Guid id)
        {
            ...
            _context.EmprestimosLivros.Remove(emprestimoLivro);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.EmprestimosLivros.Any(e => e.EmprestimoLivroId == id);
        }
    }
}
